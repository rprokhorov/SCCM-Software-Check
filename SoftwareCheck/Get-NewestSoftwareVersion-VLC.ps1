...
$script:Application = "VLC"
$script:Application_detection = 'VLC'
$script:DirAppinConsole = "VLC"
$script:DistribPath = "$($Config.DistribPath)VLC"
$script:FileName_x64 = 'vlc-%version%-win64.msi'
$script:FileName_x86 = 'vlc-%version%-win32.msi'
...
$script:templatename = 'Config_VLC_template.ps1'
$To= $Config.To
#endregion VARIABLES
