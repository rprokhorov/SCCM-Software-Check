# Получает с сайта последнюю версию VLC и если у нас нет такой версии, то сначала копирует шаблон устанвоки PSADT, заменяет в неём значения. После этого создаёт приложение в SCCM с заполнением всех нужых атрибутов.

#region FUNCTIONS
function Get-VLC ($URLPage){
    ...
    $global:Version = $Matches[0] -replace '"latestVersion":"', ''
    ...
    $DownloadURL_x64 = "https://download.videolan.org/vlc/last/win64/vlc-$global:Version-win64.msi"
    $DownloadURL_x86 = "https://download.videolan.org/vlc/last/win32/vlc-$global:Version-win32.msi"
...
function Update-VersionCompliance {
    param (
        ...
        $ProviderMachineName = "SCCMServer.contoso.com",
...
$global:Application = "VLC"
$global:Application_detection = 'VLC'
$global:DirAppinConsole = "VLC"
$global:DistribPath = "$($Config.DistribPath)\VLC"
$global:FileName_x64 = 'vlc-%version%-win64.msi'
$global:FileName_x86 = 'vlc-%version%-win32.msi'
$URLPage = "https://www.videolan.org/vlc/"
$ProxyURL = $Config.ProxyURL
$global:PSADTTemplatePath = $Config.PSADTTemplatePath
$global:body = ''
$global:NewVersion = $null
$global:Publisher = 'Simon Tatharm'
$global:templatename = 'Config_VLC_template.ps1'
$To= $Config.To
#endregion VARIABLES

Try{
    Get-VLC -URLPage $URLPage
