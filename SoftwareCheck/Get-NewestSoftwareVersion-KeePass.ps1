# Получает с сайта последнюю версию KeePass и если у нас нет такой версии, то сначала копирует шаблон устанвоки PSADT, заменяет в неём значения. После этого создаёт приложение в SCCM с заполнением всех нужых атрибутов.

#region Function
function Get-KeePass ($URLPage){
...
$global:Application = "KeePass"
$global:Application_detection = 'KeePass'
$global:DirAppinConsole = "KeePass"
$global:DistribPath = "$($Config.DistribPath)\KeePass"
$global:FileName = 'KeePass-%Version%.msi'
...
$global:Publisher = 'Dominik Reichl'
$global:templatename = 'Config_KeePass_template.ps1'
$To= $Config.To
#endregion Variables

Try{
    Get-KeePass -URLPage $URLPage
