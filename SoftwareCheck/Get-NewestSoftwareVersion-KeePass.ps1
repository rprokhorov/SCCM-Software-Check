...
$script:Application = "KeePass"
$script:Application_detection = 'KeePass'
$script:DirAppinConsole = "KeePass"
$script:DistribPath = "$($Config.DistribPath)KeePass"
$script:FileName = 'KeePass-%Version%.msi'
