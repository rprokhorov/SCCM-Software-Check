...
function Get-VisualStudioCode ($URLPage){
    ...
    $script:FileName_x64 = "VSCodeSetup-x64-$version.exe"
    $script:FileName_x86 = "VSCodeSetup-x86-$version.exe"
...
$script:Application = "Visual Studio Code"
$script:Application_detection = 'Visual Studio Code'
$script:DirAppinConsole = "Visual Studio Code"
$script:DistribPath = "$($Config.DistribPath)Visual Studio Code"
$script:FileName_x64 = 'VSCodeSetup-x64-%version%.exe'
$script:FileName_x86 = 'VSCodeSetup-x86-%version%.exe'
...
$script:templatename = 'Config_VSCode_template.ps1'
$To= $Config.To
$From = $config.From
