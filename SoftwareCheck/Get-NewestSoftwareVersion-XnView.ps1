...
$script:Application = "XnView"
$script:Application_detection = 'XnView'
$script:DirAppinConsole = "XnView"
$script:DistribPath = "$($Config.DistribPath)XnView"
$script:FileName = 'XnView-full-%Version%.exe'
