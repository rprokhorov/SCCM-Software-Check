# Получает с сайта последнюю версию XnView и если у нас нет такой версии, то сначала копирует шаблон устанвоки PSADT, заменяет в неём значения. После этого создаёт приложение в SCCM с заполнением всех нужых атрибутов.

#region Function
function Get-XnView  ($URLPage){
    ...
    $DownloadURL = ($result.Links | Where-Object {$_.href -like '*full.exe'}).href
...
$global:Application = "XnView"
$global:Application_detection = 'XnView'
$global:DirAppinConsole = "XnView"
$global:DistribPath = "$($Config.DistribPath)\XnView"
$global:FileName = 'XnView-full-%Version%.exe'
$URLPage = 'https://www.xnview.com/en/xnview/'
$global:Version = '1.1'
$ProxyURL = $Config.ProxyURL
$global:PSADTTemplatePath = $Config.PSADTTemplatePath
$global:body = ''
$global:NewVersion = $null
$global:Publisher = 'Gougelet Pierre-e'
$global:templatename = 'Config_XnView_template.ps1'
$To= $Config.To
#endregion Variables

Try{
    Get-XnView -URLPage $URLPage
