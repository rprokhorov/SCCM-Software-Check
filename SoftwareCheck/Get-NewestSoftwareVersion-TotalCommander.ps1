...
function Get-TotalCommander ($URLPage){
    ...
    $global:Version = $Matches[0] -replace 'version ' -replace ' of Total Commander'
...
$global:Application = "Total Commander"
$global:Application_detection = 'Total Commander'
$global:DirAppinConsole = "Total Commander"
$global:DistribPath = "$($Config.DistribPath)\Total Commander"
$global:FileName = 'tcmd%Version%x32_64.exe'
...
$global:Publisher = 'Ghisler Software GmbH'
$global:templatename = 'Config_TotalCommander_template.ps1'
$To= $Config.To
#endregion Variables
