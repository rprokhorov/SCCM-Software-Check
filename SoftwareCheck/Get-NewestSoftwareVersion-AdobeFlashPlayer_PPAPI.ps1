...
function Get-AdobeFlashPlayerPPAPI ($URLPage){
    ...
    Write-Host "Download path: $DistribPath\$global:Version\install_flash_player_${majorVersion}_ppapi.msi"#`n$DistribPath\$global:Version\install_flash_player_${majorVersion}_plugin.msi`n$DistribPath\$global:Version\install_flash_player_${majorVersion}_ppapi.msi`n"
    $global:FileName = "install_flash_player_${majorVersion}_ppapi.msi"
