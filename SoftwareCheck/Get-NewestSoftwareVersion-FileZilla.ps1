...
$script:Application = "FileZilla"
$script:Application_detection = 'FileZilla'
$script:DirAppinConsole = "FileZilla"
$script:DistribPath = "$($Config.DistribPath)FileZilla"
$script:FileName = 'FileZilla-%Version%.exe'
...
$script:Publisher = 'Tim Kosse'
$script:templatename = 'Config_FileZilla_template.ps1'
$To= $Config.To
#endregion Variables
