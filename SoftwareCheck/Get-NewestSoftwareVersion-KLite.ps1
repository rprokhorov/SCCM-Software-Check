...
function Get-KLite ($URLPage){
    ...
    $DownloadURL = ($result.Links | ? {$_.href -like '*exe*'})[0].href
...
$script:Application = "K-Lite Codec Pack Standard"
$script:Application_detection = "K-Lite Codec Pack*Standard"
$script:DirAppinConsole = "K-Lite Codec Pack"
$script:DistribPath = "$($Config.DistribPath)K-Lite Codec"
$script:FileName = 'K-Lite_Codec_Pack_Standard.exe'
