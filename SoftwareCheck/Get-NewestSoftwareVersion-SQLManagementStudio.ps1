...
function Get-SQLManagementStudio ($URLPage){
    ...
    $global:build = $Matches[0] -replace '[a-z \:]'
    $DownLoadURL = 'https://aka.ms/ssmsfullsetup'
    #$DownloadURL = ($result.Links | Where-Object {$_.outerHTML -like "*Download SQL Server Management Studio*$global:Version*" -and $_.outerHTML -inotlike '*upgrade*'}).href
    if (!$DownloadURL)
    {
...
$global:Application = "SQL Server Management Studio"
$global:Application_detection = 'SQL Server Management Studio'
$global:DirAppinConsole = "SQL Server Management Studio"
$global:DistribPath = "$($Config.DistribPath)\SQL Server Management Studio"
$global:FileName = 'SSMS-Setup-ENU-%version%.exe'
...
$global:Publisher = 'Microsoft'
$global:templatename = 'Config_SQLManagemetStudio_template.ps1'
$To= $Config.To
#endregion Variables
