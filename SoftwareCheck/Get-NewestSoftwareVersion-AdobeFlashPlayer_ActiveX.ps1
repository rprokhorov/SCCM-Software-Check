...
function Get-AdobeFlashPlayerActiveX ($URLPage){
    ...
    Write-Host "Download path: $DistribPath\$global:Version\install_flash_player_${majorVersion}_active_x.msi"#`n$DistribPath\$global:Version\install_flash_player_${majorVersion}_plugin.msi`n$DistribPath\$global:Version\install_flash_player_${majorVersion}_ppapi.msi`n"
    $global:FileName = "install_flash_player_${majorVersion}_active_x.msi"
...
$global:Application = "Adobe Flash Player ActiveX"
$global:Application_detection = "Adobe Flash Player*ActiveX"
$global:DirAppinConsole = "Adobe Flash Player"
$global:DistribPath = "$($Config.DistribPath)\Adobe\Flash Player ActiveX"
...
$global:templatename = 'Config_AdobeFlashPlayerActiveX_template.ps1'
$To= $Config.To
#endregion Variables
