...
$script:Application = "PuTTY"
$script:Application_detection = 'PuTTY'
$script:DirAppinConsole = "PuTTY"
$script:DistribPath = "$($Config.DistribPath)PuTTY"
$script:FileName_x64 = "PuTTY-x64-$version.msi"
$script:FileName_x86 = "PuTTY-x86-$version.msi"
...
$script:templatename = 'Config_Putty_template.ps1'
$To= $Config.To
$From = $config.From
