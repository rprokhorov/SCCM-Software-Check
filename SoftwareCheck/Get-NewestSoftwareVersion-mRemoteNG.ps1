...
$script:Application = "mRemoteNG"
$script:Application_detection = 'mRemoteNG'
$script:DirAppinConsole = "mRemoteNG"
$script:DistribPath = "$($Config.DistribPath)mRemoteNG"
$script:FileName = 'mRemoteNG-%Version%.msi'
